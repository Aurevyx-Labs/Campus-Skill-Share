...
export function BottomNav() {
  ...
  const createOptions = [
    {
      icon: BookOpen,
      label: "Skill",
      href: "/post/new?type=skill",
      color: "bg-blue-500",
    },
    {
      icon: ShoppingBag,
      label: "Product",
      href: "/post/new?type=product",
      color: "bg-green-500",
    },
    {
      icon: Briefcase,
      label: "Service",
      href: "/post/new?type=service",
      color: "bg-purple-500",
    },
    {
      icon: MapPin,
      label: "Lost & Found",
      href: "/post/new?type=lost",
      color: "bg-orange-500",
    },
    {
      icon: Calendar,
      label: "Event",
      href: "/post/new?type=event",
      color: "bg-pink-500",
    },
    {
      icon: FileText,
      label: "Job",
      href: "/post/new?type=job",
      color: "bg-red-500",
    },
  ];
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-background border-t border-border/40 flex justify-center">
        <div className="w-full max-w-screen-xl mx-auto px-4 flex items-center justify-around h-16">
          <Link
            to="/feed"
      ...
      {/* Create Modal – now inside this same file */}
      {isCreateOpen && (
          ...
          <div className="w-full max-w-md bg-background rounded-t-3xl sm:rounded-3xl p-6 pb-8 animate-in slide-in-from-bottom-10 duration-300">
            ...
            <div className="grid grid-cols-3 gap-4">
              {createOptions.map((option) => (
                ...
                >
                  <div
                    className={`w-12 h-12 rounded-full ${option.color} text-white flex items-center justify-center`}
                  >
